                        ...
                        <div class="card">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h5 class="text-white" style="margin-left: 10px;">Update New Lead</h5>
                                    ...
                                    <form method="post" class="slip" enctype="multipart/form-data">
                                        <div class="card mt-1" id="password">
                                            ...
                                            <div class="card-body pt-0">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="form-control-label"
                                                                for="input-username">Contacted Date</label>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            <label class="form-control-label"
                                                                for="input-username">Status</label>
                                                            <select class="form-control" name="country" id="country"
                                                                required onchange="getdesignation();"
                                                                style="border: 1px solid #333;">
                                                                <option value="">Select Status</option>
                                                                <option value="16"> Responded </option>
                                                                <option value="15"> Not Responded </option>
                                            ...
                                            <div class="card-footer text-end">
                                                ...
                                                <button
                                                    class="btn bg-danger text-white btn-sm float-end mt-6 mb-0">Cancel</button>
