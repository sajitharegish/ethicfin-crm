                ...
                <div class="left">
                    ...
                    <div class="left-info para">
                        <p><strong>Closed By:</strong><br>
                           <?php 
                            for ($i = 0; $i < 1; $i++) {
                                $closed_by = $ticket_details[$i]['closed_by'];
                    ...
                    <div class="left-info para">
                        ...
                        <?php 
                            for ($i = 0; $i < 1; $i++) {
                                $closed_date = $ticket_details[$i]['closed_date'];
                                // Assuming $closed_date is in the format 'Y-m-d', change it accordingly
                                $formatted_date = date('j-M-Y', strtotime($closed_date));
                                echo $formatted_date;
                            }
                        ?>
                        </p>
