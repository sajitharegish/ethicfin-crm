                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <div class="containers">
                                    <div class="item">
                                        <div>
                                            <h6 class="text-white text-capitalize ps-3">Invoice Sent Leads </h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive p-0">
                                        ...
                                        <table class="table align-items-center  mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($invoice_sent as $mailsent) {
                                                    $serialNumber++ ?>
                                                        ...
                                                        <td style="text-align:center; font-size:16px;">
                                                                <a href="view-more/<?=$mailsent['id']?>">
                                                                    ...
                                                                    <?php if(!empty($mailsent['company_name'])) : ?>
                                                                        <span style="margin-left: 10px; font-size: 12px;">(<?php echo $mailsent['company_name'] ?>)</span>
                                                                    <?php endif?>
                                                                </a>
