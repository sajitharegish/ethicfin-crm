                        ...
                        <div class="card">
                            <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                    <h5 class="text-white" style="margin-left: 10px;">Edit User</h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" id="id" type="text" name="username"
                                                                placeholder="" value="<?= $users['username'] ?>" style="border: 1px solid #333 ;"
                                                                required>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="designation"
                                                                name="designation" style="border: 1px solid #333;" value="<?= $users['designation'] ?>"
                                                               >
                                                            <div style="color: red !important"></div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <!-- <div class="col-lg-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="password" class="form-control"
                                                                id="mobile_number" name="password" value=""
