                        ...
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <div class="containers">
                                    <div class="item">
                                        <div>
                                            <h6 class="text-white text-capitalize ps-3">Trial Account Sent Leads </h6>
                                        </div>
                                    </div>
                                    ...
                                    <div class="table-responsive p-0">
                                        ...
                                        <table class="table align-items-center  mb-0">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($trial_accounts as $trial_account) {
                                                    $serialNumber++ ?>
                                                    <tr id="row42" style="font-size:20px;" class="text-center">
                                                        <td>
                                                            ...
                                                            <td style="text-align:center; font-size:16px;">
                                                                <a href="view-more/<?=$trial_account['id']?>">
                                                                    <?= $trial_account['customer_name'] ?>
                                                                </a>
                                                                <br>
                                                                <?php if(!empty($trial_account['company_name'])) : ?>
                                                                    <span style="margin-left: 28px; font-size: 12px;">(<?php echo $trial_account['company_name'] ?>)</span>
                                                                <?php endif?>
                                                            </td>

                                                            <td style="text-align:center; font-size:16px;">
                                                                <?= $trial_account['email'] ?><br>
                                                                <?= $trial_account['mobile_number'] ?>
                                                            </td>
                                                        
                                                        
                                                        <td style="text-align:center; font-size:16px;">
                                                            <?php
                                                            $formattedDate = date('d-M-Y', strtotime($trial_account['trial_sent_date']));
                                                            echo $formattedDate;
                                                         ?></td>
                                                        <td  class="text-danger"style="text-align:center; font-size:16px;">
                                                            <?php
                                                                $formattedDate = date('d-M-Y', strtotime($trial_account['trial_expiry_date']));
                                                                echo $formattedDate;
                                                            ?>
                                                        </td>
                                                        <td style="text-align:center; font-size:16px">
                                                            <?= $trial_account['trial_account_username'] ?>
                                                        </td>
